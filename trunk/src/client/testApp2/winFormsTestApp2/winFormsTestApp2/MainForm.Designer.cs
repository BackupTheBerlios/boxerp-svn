namespace winFormsTestApp2
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.OnTestProxy2);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.OnTestDynProxy);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.OnTestWithCollection);
			// 
			// MainForm
			// 
