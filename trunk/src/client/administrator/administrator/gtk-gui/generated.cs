    ...
    internal class Gui {
        ...
        public static void Build(object cobj, string id) {
            ...
            if ((id == "administrator.MainWindow")) {
                Stetic.SteticGenerated.administratorMainWindow.Build(((Gtk.Window)(cobj)));
            }
            else {
                if ((id == "administrator.EditUserWindow")) {
                    Stetic.SteticGenerated.administratorEditUserWindow.Build(((Gtk.Window)(cobj)));
                }
                else {
                    if ((id == "administrator.LoginWindow")) {
                        Stetic.SteticGenerated.administratorLoginWindow.Build(((Gtk.Window)(cobj)));
                    }
                    else {
                        if ((id == "administrator.EditCreateUser")) {
                            Stetic.SteticGenerated.administratorEditCreateUser.Build(((Gtk.Window)(cobj)));
                        }
                    }
                }
            }
